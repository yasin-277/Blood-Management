...
{
$sql=mysqli_query($con,"SELECT password FROM volunteer where password='".md5($_POST['cpass'])."' && id='".$_SESSION['v_id']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update volunteer set password='".md5($_POST['newpass'])."' where id='".$_SESSION['v_id']."'");
